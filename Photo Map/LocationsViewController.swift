...
@objc protocol LocationsViewControllerDelegate : class {
    @objc func locationPickedLocation(controller: LocationsViewController, latitude: NSNumber, longitude: NSNumber)
}
...
class LocationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.locationPickedLocation(controller: self, latitude: lat, longitude: lng)
    }
